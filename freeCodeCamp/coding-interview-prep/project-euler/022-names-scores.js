...
function namesScores(arr) {
    ...
    // helper function to calculate the ASCII value of a string
    const ASCIIValue = (text) => {
        let value = 0;

        for (let i = 0; i < text.length; i++) {
            value += text.charCodeAt(i) - 64;
        }
    ...
    return sorted.reduce((s, t, i) => s += ASCIIValue(t) * (i + 1), 0);
}
...
console.log(namesScores(test1), 791);
console.log(namesScores(test2), 1468);
console.log(namesScores(names), 871198282);